...
if os.environ.get("VERCEL"):
    SETTINGS_FILE = Path("/tmp/schedule_settings.json")
else:
    SETTINGS_FILE = Path(__file__).resolve().parent / "schedule_settings.json"

DEFAULT_SETTINGS = {
    "recipients": ["chintan@wohlig.com", "jagruti@wohlig.com", "chirag@wohlig.com", "ankit.shrivastav@wohlig.com"],
    "next_run": None,
    "stop_run": None,
    "continuous": False,
    "active": False,
...
def check_schedule_action(settings):
    ...
    # No next_run set: run once if never run before
